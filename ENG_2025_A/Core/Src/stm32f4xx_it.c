...
void EXTI0_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(ARM_LIFT_WD_Pin);
...
if (__HAL_UART_GET_FLAG(&huart3, UART_FLAG_IDLE) &&
        ...
        referee_data_solve(USART3_Rx_Buffer); // 图传链路和常规链路一人一个
			decodeDataFrame(USART3_Rx_Buffer);
					device_time[UART_IMAGE]=0;
        /* restart dma transmission */
        __HAL_DMA_SET_COUNTER(huart3.hdmarx, UART8_RX_BUFFER_SIZE);
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(Camera_LIFT_WD_Pin);
...
void UART8_IRQHandler(void)
{
  /* USER CODE BEGIN UART8_IRQn 0 */
    ...
    if (__HAL_UART_GET_FLAG(&huart8, UART_FLAG_IDLE) &&
        ...
        /* handle referee data from DMA */
        referee_data_solve(UART8_Rx_Buffer); // 图传链路和常规链路一人一个
			decodeDataFrame(UART8_Rx_Buffer);
					device_time[UART_REF]=0;
        /* restart dma transmission */
        __HAL_DMA_SET_COUNTER(huart8.hdmarx, UART8_RX_BUFFER_SIZE);
